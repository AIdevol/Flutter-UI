...
import 'package:flutter_ecommerce/common_widget/GridTilesCategory.dart';
import 'package:flutter_ecommerce/models/CategoryModel.dart';
...
Future<List> getCategoryList(String slug, bool isSubList) async {
  if (isSubList) {
    categories;
  }
  if (categories == null) {
